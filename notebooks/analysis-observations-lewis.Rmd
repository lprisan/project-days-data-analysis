...
Even though we already have a quite good idea of what the MCA dimensions represent, a visual inspection
...
dataframes and is used by the function `merge_with_data(data, iq, fq)`, who adds columns to the observer dataset
...
```{r}
merged_data <- merge_with_data(processed_data, iq=iq_data, fq=fq_data)
```
